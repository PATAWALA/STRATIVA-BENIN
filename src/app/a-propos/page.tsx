    ...
    <main className="pt-28 pb-24">
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-8 mb-24">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="text-center">
            <div className="w-12 h-12 mx-auto rounded-full bg-indigo/10 flex items-center justify-center mb-4">
          ...
          <div className="text-center">
            <div className="w-12 h-12 mx-auto rounded-full bg-benin-green/10 flex items-center justify-center mb-4">
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-8 mb-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {valeurs.map((v, i) => (
            <div key={i} className="rounded-2xl border border-champagne/60 bg-white p-6 text-center">
              <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-gold/10 text-gold font-bold text-sm mb-3">{i + 1}</span>
          ...
          {equipe.map((membre, i) => (
            <div key={i} className="text-center p-8 bg-white rounded-2xl border border-champagne/60 shadow-sm">
              <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-indigo/10 flex items-center justify-center">
                <span className="text-2xl font-bold text-indigo/40">{membre.nom.charAt(0)}</span>
              </div>
